...
namespace NuttyApp.Constants{
	...
	//Set paths relative to the install location for icons
	...
	public static const string TEXT_FOR_DEVICES_COLUMN_NAME_2 = _("Host Name");
	public static const string TEXT_FOR_DEVICES_COLUMN_NAME_3 = _("Host Manufacturer");
	public static const string TEXT_FOR_DEVICES_COLUMN_NAME_4 = _("Discovery Date");
	public static const string TEXT_FOR_DEVICES_COLUMN_NAME_5 = _("Host IP");
	public static const string TEXT_FOR_DEVICES_COLUMN_NAME_6 = _("Host MAC");
	...
	public static const string nutty_script_path = "/opt/nutty";
