...
CRONTAB_TEMPFILE=$3
CRONTAB_15_MIN_SCHEDULE="*/13 * * * * export DISPLAY=:0 && /usr/bin/com.github.babluboy.nutty --alert"
CRONTAB_30_MIN_SCHEDULE="*/28 * * * * export DISPLAY=:0 && /usr/bin/com.github.babluboy.nutty --alert"
CRONTAB_60_MIN_SCHEDULE="*/55 * * * * export DISPLAY=:0 && /usr/bin/com.github.babluboy.nutty --alert"
CRONTAB_1440_MIN_SCHEDULE="0 1 * * * export DISPLAY=:0 && /usr/bin/com.github.babluboy.nutty --alert"
